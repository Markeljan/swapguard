...
const Swap: NextPage = () => {
  ...
  const { data: userTokenData } = useScaffoldContractRead({
    contractName: "YourContract", // Change as per your setup
    functionName: "getUserTokens", // This function should return the list of tokens a user has
  });
    ...
    <>
     ...
     <div className="bg-gray-900 text-white text-center py-4">
      ...
      <div className="bg-gray-900 min-h-screen flex items-center justify-center">
        <div className="bg-gray-800 p-6 rounded-xl w-96">
          <div className="flex justify-between items-center mb-4">
            <p className="text-xl font-medium text-white">Trade</p>
            <button className="bg-gray-700 p-1 rounded-full hover:bg-gray-600">
              <img src="/path-to-settings-icon.svg" alt="Settings" />
            </button>
          </div>
          ...
          <button onClick={handleSwap} className="bg-purple-600 mt-4 py-2 w-full rounded-md text-white">
            Swap Tokens
          </button>
        </div>
      </div>
